...
Copyright Jean-François Subrini, student DA Python at OpenClassrooms, 15/02/2018.
...
class Place:
    ...
    def parsing(self):
        ...
        words = re.sub(r"[.!,;?]", " ", self.sentence).split()
        # To remove ... 
    ...
    def coordinates(self, sentence):
        ...
        # api_key = "AIzaSyCdrPZF5a3PPvxwXaAq-kTgGun5WEDRj-E"
        response = requests.get("https://maps.googleapis.com/maps/api/geocode/json?address={}&key={}"\
        .format(self.sentence, GOOGLE_MAPS_KEY_GEOCODING))
